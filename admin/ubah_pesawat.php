...
$sql = "SELECT * FROM airlines_list WHERE airlines_id=$id";
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                    <form action="proses_ubah_pesawat.php" method="POST">
                    <input type="hidden" name="airlines_id" value="<?=$user["airlines_id"]; ?>"/>
                        <div class="form-group">
                          <label class="control-label">Airlines</label>
                          <input name="airlines" id="" cols="30" rows="2" class="form-control" value="<?=$user["airlines"]; ?>">
                        </div>
                    </div>
