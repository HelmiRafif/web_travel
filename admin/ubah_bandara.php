...
$sql = "SELECT * FROM airport_list WHERE id=$id";
$query = mysqli_query($db, $sql);
$air = mysqli_fetch_assoc($query);
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="card">
                    ...
                    <input type="hidden" name="id" value="<?php echo $air['id'] ?>" />
                        <div class="form-group">
                          <label class="control-label">Airport</label>
                          <input name="airport" cols="100" rows="10" class="form-control" value="<?php echo $air['airport'] ?>">
                        </div>
                        <div class="form-group">
                          <label class="control-label">Location</label>
                          <input name="location" id="" cols="30" rows="2" class="form-control"  value="<?php echo $air['location'] ?>">
                        </div>
                    </div>
