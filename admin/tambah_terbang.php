          ...
          <div class="container-fluid">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <div class="card">
                    ...
                    <div class="card-body">
                    <form action="proses_terbang.php" method="POST">
                    <div class="form-group">
                          ...
                          <option></option>
                          <?php 
                          $kon = mysqli_connect("localhost",'root',"","flight_db");
                          if (!$kon){
                            die("Koneksi database gagal:".mysqli_connect_error());
                          }
                          $airline = $kon->query("SELECT * FROM airlines_list order by airlines asc");
                          while($row = $airline->fetch_assoc()):
                          ?>
                            <option value="<?php echo $row['id'] ?>" <?php echo isset($airlines_id) && $airlines_id == $row['id'] ? "selected" : '' ?>><?php echo $row['airlines'] ?></option>
                          <?php endwhile; ?>
                        </select>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group">
                          ...
                          <input name="plane_no" id="" cols="30" rows="2" class="form-control">
                        </div>
                    </div>
                    </div>
            ...
            if (!$kon){
              die("Koneksi database gagal:".mysqli_connect_error());
							...
							$airport = $kon->query("SELECT * FROM airport_list order by airport asc");
              ...
              die("Koneksi database gagal:".mysqli_connect_error());
                ...
                <div class="col-md-8">
                    <div class="form-group">
                          ...
                          <input name="seat" id="" cols="30" rows="2" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                          ...
                          <input name="price" id="" cols="30" rows="2" class="form-control">
                        </div>
                    </div>
                    </div>
			</div>
