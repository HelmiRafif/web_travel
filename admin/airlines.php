        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Airlines</h1>
                  ...
                  <div class="card-header">
                    <large class="card-title">
                      <b>Airlines List</b>
                        ...
                        <a href = "tambah_pesawat.php" class="btn btn-sm btn-primary col-sm-2 offset-md-2 float-right"><i class="fa fa-plus"></i> Tambah</a>
                    ...
                    <div class="card-body">
                      <table class="table table-bordered table-hover">
                        ...
                        while ($air = mysqli_fetch_array($query)){
                          ...
                          echo "<td>".$air['airlines']."</td>";

                          echo "<td>";
                          echo "<a href='ubah_pesawat.php?airlines_id=".$air['airlines_id']."'>Edit</a> | ";
                          echo "<a href='hapus_pesawat.php?airlines_id=".$air['airlines_id']."'>Hapus</a>";
                          echo "</td>";
